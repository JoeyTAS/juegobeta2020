alert("Nivel 1: Evita que ingresen insectos" );
...
function initCanvas(){
    ...
    var renderEnemies = function (enemyList) {
        for (var i = 0; i < enemyList.length; i++) {
            ...
            ctx.drawImage(enemyList[i].image, enemyList[i].x, enemyList[i].y += .8, enemyList[i].w, enemyList[i].h); // aqui esta el tiempo el 5 
            ...
            for (var i = 0; i < enemies.length; i++) {
                ...
                if(m.x+m.w >= e.x && 
                   ...
                   m.y <= e.y+e.h){
                    ...
                    enemies.splice(i, 1); 
                    document.querySelector('.barra').innerHTML = "Puntos:"+ e.id  +" ";
                    document.getElementById("puntos").innerHTML = "Puntos: " + mi +  "/" + necesario;
