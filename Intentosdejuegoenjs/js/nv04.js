alert("Nivel 5: Evita que ingresen insectos" );
function initCanvas(){
    ...
    var renderEnemies = function (enemyList) {
        for (var i = 0; i < enemyList.length; i++) {
            ...
            ctx.drawImage(enemyList[i].image, enemyList[i].x, enemyList[i].y += .5, enemyList[i].w, enemyList[i].h); // aqui esta el tiempo el 5 
